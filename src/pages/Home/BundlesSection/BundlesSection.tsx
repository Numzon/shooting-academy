      ...
      <div className="row">
        ...
        <div className="col-4">
          <BundleCard>
            ...
            <BundleCardSideBack buttonType="secondary" price="234$" to="#" color="tertiary">
        ...
        <div className="col-4">
          <BundleCard>
            ...
            <BundleCardSideBack buttonType="primary" price="224$" to="#" color="secondary">
        ...
        <div className="col-4">
          <BundleCard>
            ...
            <BundleCardSideBack buttonType="tertiary" price="124$" to="#" color="primary">
              <li>07/11/2024 - 14/11/2024</li>
              <li>12/02/2025 - 19/02/2025</li>
            </BundleCardSideBack>
          </BundleCard>
